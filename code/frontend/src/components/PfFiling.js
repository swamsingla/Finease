    ...
    <Container maxWidth="lg" style={{ paddingBottom: '80px', backgroundColor: 'white', minHeight: '100vh', color: 'black' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <Typography variant="h6">PF Filing</Typography>
        </div>
      </div>
      ...
      <div className="max-w-md mx-auto bg-gray-50 p-4 rounded-lg">
        ...
        <div style={{ 
          ...
          <Typography variant="h5" style={{ marginBottom: '16px' }}>Provident Fund Filing</Typography>
          <Typography variant="body1">
            This feature will be available soon. You'll be able to submit your provident fund documents here.
          </Typography>
        </div>
      </div>
      ...
      <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, backgroundColor: 'white', borderTop: '1px solid #e0e0e0' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', padding: '16px' }}>
          ...
          <NavItem icon={<Receipt />} label="File" onClick={() => navigate('/file')} active={location.pathname === '/file' || location.pathname === '/pf-filing'} />
