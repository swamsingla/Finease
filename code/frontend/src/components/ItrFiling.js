    ...
    <Container maxWidth="lg" style={{ paddingBottom: '80px', backgroundColor: 'white', minHeight: '100vh', color: 'black' }}>
      ...
      <div className="max-w-md mx-auto bg-gray-50 p-4 rounded-lg">
        ...
        <div style={{ 
          ...
          <Typography variant="h5" style={{ marginBottom: '16px' }}>Income Tax Return Filing</Typography>
          <Typography variant="body1">
            This feature will be available soon. You'll be able to submit your income tax returns here.
          </Typography>
        </div>
      </div>
